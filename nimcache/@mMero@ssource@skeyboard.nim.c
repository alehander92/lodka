...
static const NimStringV2 TM__ZrVepqz9a1O4OWN5tc4Iqnw_4 = {9, (NimStrPayload*)&TM__ZrVepqz9a1O4OWN5tc4Iqnw_3};
static const struct {
  NI cap; void* allocator; NIM_CHAR data[24+1];
} TM__ZrVepqz9a1O4OWN5tc4Iqnw_5 = { 24, NIM_NIL, "Unrecognized scancode..." };
static const NimStringV2 TM__ZrVepqz9a1O4OWN5tc4Iqnw_6 = {24, (NimStrPayload*)&TM__ZrVepqz9a1O4OWN5tc4Iqnw_5};
static const struct {
  NI cap; void* allocator; NIM_CHAR data[17+1];
} TM__ZrVepqz9a1O4OWN5tc4Iqnw_7 = { 17, NIM_NIL, "GOT DEBUG SIGNAL!" };
static const NimStringV2 TM__ZrVepqz9a1O4OWN5tc4Iqnw_8 = {17, (NimStrPayload*)&TM__ZrVepqz9a1O4OWN5tc4Iqnw_7};
...
N_NIMCALL(void, keyboardHandler)(tyObject_registers__Mb0UOAid9c9c7v7uFPX18mcg* regs) {	NimStringV2 colontmpD_;
	...
	TSafePoint TM__ZrVepqz9a1O4OWN5tc4Iqnw_2;
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
	pushSafePoint(&TM__ZrVepqz9a1O4OWN5tc4Iqnw_2);
	TM__ZrVepqz9a1O4OWN5tc4Iqnw_2.status = setjmp(TM__ZrVepqz9a1O4OWN5tc4Iqnw_2.context);
	if (TM__ZrVepqz9a1O4OWN5tc4Iqnw_2.status == 0) {
		NU8 scancode;
		consoleWriteNl__RpCx8d9a9cozNvS9aKPon6r9cQ(TM__ZrVepqz9a1O4OWN5tc4Iqnw_4);
		scancode = inb__HQ0Xhmit0RzG5MHuATBKcQ(((NU16) 96));
		{
			...
			LA8_: ;
			{
				consoleWriteNl__RpCx8d9a9cozNvS9aKPon6r9cQ(TM__ZrVepqz9a1O4OWN5tc4Iqnw_6);
			}
			LA6_: ;
		}
		goto LA2_;
		LA4_: ;
		{
			...
			LA15_: ;
			{
				consoleWriteNl__RpCx8d9a9cozNvS9aKPon6r9cQ(TM__ZrVepqz9a1O4OWN5tc4Iqnw_8);
				consoleWrite__RpCx8d9a9cozNvS9aKPon6r9cQ_2(TM__ZrVepqz9a1O4OWN5tc4Iqnw_9);
			}
			LA13_: ;
		}
		LA2_: ;
